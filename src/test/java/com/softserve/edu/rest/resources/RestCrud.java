...
public abstract class RestCrud {
    ...
    private final String PATH_LEFT_BRACE = "{";
    private final String PATH_RIGHT_BRACE = "}";
    //
...
//    }
    ...
    private String preparePathVariables(String urlTemplate, RestParameters pathVariables) {
        ...
        if (pathVariables != null) {
            for (String currentKey : pathVariables.getAllParameters().keySet()) {
                searchVariable = PATH_LEFT_BRACE + currentKey + PATH_RIGHT_BRACE;
                if (url.contains(searchVariable)) {
                    url = pathPreparing(url, searchVariable, pathVariables, currentKey);
                }
            }
        }
        return url;
    ...
    private String pathPreparing(String url, String searchVariable, RestParameters pathVariables, String currentKey) {
        return url.replaceFirst(Pattern.quote(searchVariable), pathVariables.getParameter(currentKey));
    }
