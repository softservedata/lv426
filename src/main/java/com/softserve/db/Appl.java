...
public class Appl {
	...
	private static String username = "lv414";
	private static String password = "lv414_TAQC";
	//
	// Microsoft
	...
	private static String URL = "jdbc:mysql://10.26.34.214:3306/opencart";
	//
	// PostgresSQL
	// private static String URL =
...
//		st.execute("DELETE FROM MyUsers WHERE id=5;");
		...
		//
		st.execute("UPDATE oc_customer_login SET total='1' WHERE email LIKE 'a%';");
